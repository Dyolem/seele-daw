...
2. 在 Workbench 创建默认选择 Studio Grand 的 Instrument Track；MIDI 导入按已审核 Program 与
   Channel 10 选择音源；在 Inspector 从 22 项内置目录手动选择或替换音色，也可显式修复旧项目的
   空 Instrument Slot、不可用 Program 占位与 Missing Instrument。
