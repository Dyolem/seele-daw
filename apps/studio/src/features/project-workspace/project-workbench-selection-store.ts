...
export const useProjectWorkbenchSelectionStore = defineStore('project-workbench-selection', () => {
  ...
  function reconcileProject(
    ...
    if (selectedClip !== null) {
      ...
      if (currentClip !== undefined && availableTrackIds.includes(currentClip.trackId)) {
